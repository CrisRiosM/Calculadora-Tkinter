...
from tkinter import Tk,Text,END,re
...
class Interfaz:
	...
	def __init__(self, ventana):
		...
		self.pantalla = Text(ventana, state="disabled", width =40, height= 3, background="orchid", foreground = "white", font ="Helvetica") 
        ...
        #UBICARLOS EN EL GESTOR DEL GRID

        botones=[boton1,boton2,boton3,boton4,boton5,boton6,boton7,boton8,boton910,boton11,boton12,boton13,boton14,boton15,boton16,boton17]
        contador = 0
        ...
        # metodo click controla el evento disparamdo a hacer click en un boton

        def click(self, texto, escribir):

        	if not escribir:
        		if texto=="=" and self.operacion!= "":
        			self.operacion=re.sub(u"\u00F7","/",self.operacion) #del metodo re, sub para sustituir un caracter por otro dentro de determinado string
                    resultado= str(eval(self.operacion))#evaluar una operacion atematica de tipo string
                    self.operacion=""
